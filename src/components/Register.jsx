        ...
        <div className='min-h-screen grid place-content-center gap-10'>
            ...
            <div className="bg-ctp-base rounded-2xl py-10 px-5 flex flex-col gap-10 w-96">
                ...
                <form className='flex flex-col gap-3' onSubmit={handleSubmit}>
                    ...
                    <button type="submit" className="border-2 px-3 py-1 rounded-lg flex justify-center gap-5 hover:bg-ctp-mantle text-lg"><FiLogIn className='w-5 h-5 mt-1' />Sign Up</button>
                    <span className='hover:underline cursor-pointer select-none' onClick={() => setLocation("/login")}>Already have an account? Sign In</span>
                </form>
                <button onClick={signInWithGoogle} className="border-2 px-3 py-2 rounded-lg flex justify-center gap-5 hover:bg-ctp-mantle">
                    <BsGoogle className='w-5 h-5' />Sign Up With Google
                </button>
            </div>
